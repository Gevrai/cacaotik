...
wss.on('connection', (ws) => {
  ...
  // Send this player their own info
  ws.send(JSON.stringify({ type: 'init', id, color: player.color, gridX: player.gridX, gridY: player.gridY, gridSize: GRID_SIZE, gridCols: GRID_COLS, gridRows: GRID_ROWS }));
